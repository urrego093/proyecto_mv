...
'Also you can mix both expresions: user 1-3, newuser, otheruser 1-9': 'También puedes mezclar ambas expresiones: Usuario 1-3, nuevoUsuario, otroUsuario 1-9',
...
'Are you sure that you want to accept this user as a teacher?': '¿Está seguro que quiere aceptar a este usuario como docente ?',
'Are you sure that you want to accept this user as a teacher? ': '',
'Are you sure that you want to reject this user petition?': '¿Está seguro de eliminar ésta petición de registro?',
...
'clean': 'limpiar',
'Clean Machines': 'Limpiar máquinas',
'Clear': 'Limpiar',
...
'Click over one machine to list all running services': 'Haz clic sobre una máquina para listar todos los servicios activos',
...
'Do you really want to restart the selected machines?': 'Desea reiniciar las máquinas seleccionadas?',
'Do you really whish to restart the selected machines?': 'Desea reiniciar las máquinas seleccionadas?',
...
'Enter an integer greater than or equal to %(min)g': 'Ingrese un entero mayor o igual que  %(min)g',
...
'For this task, please select just one machine': 'Para ésta tarea por favor seleccione una sola máquina',
...
'merge': 'combinar',
'Minimum lenght is 6 and at least one character must be a capital letter': 'La longitud mínima es 6 y al menos una letra debe ser mayúscula',
...
"Please click on 'Course groups' to list all the groups of the course": "Por favor haga clic en 'Grupos del curso' para listar todos los grupos del curso.",
"Please click on 'Machines' to list all the machines assigned to the course": "Haga clic en 'Equipos' para mostrar las máquinas asignadas al curso.",
'Please enter port numbers separated by comma': 'Ingrese los números de los puertos separados por comas, ',
...
'Please list the services you want to restart': 'Liste los servicios que desea reiniciar separados por coma.',
'Please list the services you want to start': 'Liste los servicios que desea iniciar separados por coma.',
'Please list the services you want to stop': 'Liste los servicios que desea detener separados por coma.',
'Please list the services you want to stop separated by comma': 'Liste los servicios que desea detener separados por coma.',
...
'Please select a row to assign a student to the port': 'Seleccione una fila para asignar un estudiante al puerto.',
'Please select an action for each user request': 'Seleccione una acción para cada petición de usuario.',
...
'Please select which action you would like to do': '¿Qué desea hacer?',
'Plugins': 'Plugins',
'Port': 'Puerto',
'Ports': 'Puertos',
'ports': 'puertos',
...
'PPA repositories like ppa:nginx/stable  will work in Ubuntu but not in Debian': 'repositorios PPA como  ppa:nginx/stable  pueden funcionar en Ubuntu pero o en Debian',
'Preface': 'Prefacio',
'Previous': 'Anterior',
...
'Register courses and groups': 'Registrar cursos y grupos',
'Register Group': 'Registrar grupo',
'Register Machine': 'Registrar Maquina',
'Register machines': 'Registrar máquinas',
...
'Remember that some packages have different names according to the distribution': 'Recuerde que algunos paquetes tienen nombres diferentes dependiendo a la distribución.',
'Remember that some packages have different names according to the distribution, i.e. Debain=apache2  RedHat=httpd': 'Recuerde que algunos paquetes tienen nombres diferentes dependiendo a la distribución., por ejemplo Debain=apache2  RedHat=httpd',
'Remember that some packages may have different names according to the distribution': 'Recuerde que algunos paquetes tienen nombres diferentes dependiendo a la distribución.',
'Remember that some repositories may have different names according to the distribution and version': 'Recuerde que algunos repositorios tienen nombres diferentes dependiendo a la distribución.',
'remote': 'remoto',
...
'Search': 'Buscar',
'Select': 'Seleccionar',
'Select a file and the users that must recieve that file': 'Seleccione un archivo y los usuarios que deben recibir dicho archivo.',
'Select file': 'Select file',
'Select One': 'Seleccione Uno',
'Select one configuration for the system packages auto update': 'Seleccione una configuración para programar la actualización de los paquetes del sistema.',
'Select one configuration of auto-tasks update': 'Seleccione una configuración para programar la actualización de los paquetes del sistema.',
...
'Some packages versions and names could differ between distributions': 'Los nombres y versiones de algunas aplicaciones pueden variar entre distribuciones.',
'somelist': 'somelist',
'Source': 'Origen',
...
'Support': 'Soporte',
'Support for DNF in Fedora >= 22 distributions included!': 'Distribuciones Fedora >= 22 con DNF soportadas',
'Support for dnf in Fedora >= 22 distributions included!': 'Distribuciones Fedora >= 22 con DNF soportadas',
'Support for dnf in Fedora >= 22 included': 'Versiones de Fedora >= 22 soportadas',
'Support for these distributions is not implemented yet': 'El soporte para esta distribución aún no está implementado',
'support for these distributions is not tested yet': 'El soporte para esta distribución aún no está probado',
'Support for these distributions is not tested yet': 'El soporte para esta distribución aún no está probado',
'Sure you want to delete this object?': '¿Está seguro que desea eliminar este objeto?',
'System': 'Sistema',
'SYSTEM CONFIGURATION': 'CONFIGURACIÓN DE SISTEMA',
'System tasks': 'Tareas de sistema',
'Table': 'tabla',
...
'The .repo extension will be added automatically': 'La extensión .repo será agregada de manera automática',
...
'The task will have the name "actualizacion" ': 'La tarea tendrá el nombre "actualizacion" ',
...
'These are the files that you have uploaded': 'Éstos son los archivos que has subido.',
...
'This will delete the registry in the database': 'Esto eliminará el registro de la base de datos.',
'Ticket': 'Tiquete',
...
'Weekday': 'Día de la semana',
'Welcome': 'Bienvenido',
'Welcome %(username)s! Click on the link %(link)s to verify your email': 'Bienvenido %(username)s! Haga clic sobre el link %(link)s para verificar su correo.',
...
"With YUM and DNF you can use URL's instead of package names": "Con YUM y DNF se pueden usar URL's en vez de nombres de paquetes.",
'Working...': 'Trabajando...',
'XML': 'XML',
...
"You can install  'apache,httpd' but some errors will appear, its recommended to install packages per Distribution": "Puede instalar  'apache,httpd' pero algunos errores aparecerán, así que se recomienda instalar paquetes por distribución.",
"You can install  'apache,httpd' but some errors will appear, its recommended to install packages per distribution": "Puede instalar  'apache,httpd' pero algunos errores aparecerán, así que se recomienda instalar paquetes por distribución.",
"You can install  'apache2,httpd' but some errors will appear, its recommended to install packages per distribution": "Puede instalar  'apache,httpd' pero algunos errores aparecerán, así que se recomienda instalar paquetes por distribución.",
"You can install 'apache,httpd' but some errors will appear, its recommended to install packages per Distribution": "Puede instalar  'apache,httpd' pero algunos errores aparecerán, así que se recomienda instalar paquetes por distribución.",
"You can install install 'apache,httpd' but some errors will appear, its recommended to install packages per Distribution": "Puede instalar  'apache,httpd' pero algunos errores aparecerán, así que se recomienda instalar paquetes por distribución.",
...
"You can remove  'apache2,httpd' but some errors will appear, its recommended to remove packages per distribution": "Puede remover  'apache,httpd' pero algunos errores aparecerán, así que se recomienda instalar paquetes por distribución.",
