...
'Change password': 'Cambie la contraseña',
'change password': 'cambie la contraseña',
'Change user(s) pass': 'Change user(s) pass',
...
'Create one? (Courses have to exist)': 'Create one? (Courses have to exist)',
...
'Currently there are no students': 'Currently there are no students',
...
'htmledit': 'htmledit',
'Id': 'Id',
'Id Machine:Port': 'Id Machine:Port',
...
'Please request the admin to create one': 'Please request the admin to create one',
...
'Record id': 'Id de registro',
'Redes de Computacion I': 'Redes de Computacion I',
'Redes de Computacion II': 'Redes de Computacion II',
'register': 'regístrese',
'Register': 'Regístrese',
...
'Schedule packages upadte': 'Schedule packages upadte',
...
'Support for dnf in Fedora >= 22 distributions included!': 'Support for dnf in Fedora >= 22 distributions included!',
'Support for dnf in Fedora >= 22 included': 'Support for dnf in Fedora >= 22 included',
...
'There are no active services': 'There are no active services',
'There are no controllers': 'No hay controladores',
'There are no machines created': 'There are no machines created',
...
'These are your machines sws': 'These are your machines sws',
